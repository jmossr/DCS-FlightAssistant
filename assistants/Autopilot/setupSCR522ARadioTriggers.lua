...
onDeviceArgument(0, channelA_Arg).value(1).fireSignal('RADIO_A')
onDeviceArgument(0, channelB_Arg).value(1).fireSignal('RADIO_B')
onDeviceArgument(0, channelC_Arg).value(1).fireSignal('RADIO_C')
onDeviceArgument(0, channelD_Arg).value(1).fireSignal('RADIO_D')
